      ...
      meta: [
        {
          hid: 'og:url',
          property: 'og:url',
          content: `https://nagano-engineer-life.netlify.app/archive/category/${this.$route.params.category}/page/${this.$route.params.page}`,
        },
        {
          hid: 'og:title',
          property: 'og:title',
          content: `カテゴリ - ${this.$route.params.category} | 長野エンジニアライフ`,
        },
      ],
    };
  }
